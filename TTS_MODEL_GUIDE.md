...
> Dialect Converter v2.2.0 — VoxCPM 为主，多模型并存
> 主要模型：VoxCPM（9 大方言组原生支持）
> 备选模型：Seed Audio / MiniMax / ElevenLabs / Mureka（覆盖全部 30 种方言）
...
> 以下模型用于 VoxCPM 不支持的 9 种方言（北京话、湖南话、客家话、赣语、晋语、南京话、福州话、兰州话、青海话），也可作为 VoxCPM 方言的备选方案。
