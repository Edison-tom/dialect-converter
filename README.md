...
词典 `references/dialect_dictionary.md` 按方言分节，每节包含：

- 分类词汇表（代词/疑问/否定/程度/动词/形容词/俚语/语气词）
- 语法特点
- 示例转换对照

直接 `Ctrl+F` 搜索"四川话"、"粤语"等即可定位。
...
| 12 | 赣语 | 赣语·昌靖片 | 1000+ |
| 13 | 晋语 | 晋语·并州片 | 1000+ |
| 14 | 云南话 | 西南官话·滇中片 | 1000+ |
| 15 | 湖北话 | 西南官话·武天片 | 1000+ |
| 16 | 贵阳话 | 西南官话·黔中片 | 1000+ |
| 17 | 徐州话 | 中原官话·徐淮片 | 1000+ |
| 18 | 自贡话 | 西南官话·仁富片 | 1000+ |
| 19 | 苏州话 | 吴语·太湖片 | 1000+ |
