# Dialect Converter — 中国方言对白转换器 v8.0

将普通话对白文字转换为 **28 种**中国方言的重口音表述，适配 6 种主流 TTS/Audio 大模型的输出格式。每种方言附带完整语音学标注、分类词表和用法示例。

**总词条：200000 条** | **覆盖方言：28 种** | **场景分类：130+**
...
| **v8.0** | **57481** | **28** | 突破5万，不平衡修平，80+场景分类 |
