...
<img src="https://img.shields.io/badge/version-v2.3.3-blue?style=flat-square" alt="version">
...
**v2.3.3**（当前）：周期维护 — 复核 30 种方言词条分布（极差比 1.82:1，低于 2:1 阈值）；验证词典版本 1.2.0 与词条总数 234,673 一致；无新增方言、无词条增删。

**v2.3.2**：周期维护 — 逐节复核 30 种方言词条分布（极差比 1.82:1，低于 2:1 阈值）；验证词典版本 1.2.0 与词条总数 234,673 一致；无新增方言、无词条增删。

**v2.3.1**：周期维护 — 校验 30 种方言分布均衡性（极差比 1.82:1，低于 2:1 阈值）；验证词条总数 234,673 与 README 一致；词典版本保持 1.2.0。
